package me.Mugi.FinerFlips.utils;
...
public class Utils {
    ...
    public static JsonElement getJson(String jsonUrl) throws IOException {
        ...
        conn.setRequestProperty("User-Agent", "FinerFlips/1.0");
    ...
    public static void sendMessageWithPrefix(String message) {
        UChat.chat(EnumChatFormatting.GOLD + ("[FF] ") + message.replaceAll("&", "§"));
    }

    public static void sendMessageWithPrefix(String message, ClickEvent clickEvent) {
        UTextComponent result = new UTextComponent(EnumChatFormatting.GOLD + ("[FF] ") + message.replaceAll("&", "§"));
